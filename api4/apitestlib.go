...
func CheckEtag(t *testing.T, data interface{}, resp *model.ResponseMetadata) {
...
func CheckNoError(t *testing.T, resp *model.ResponseMetadata) {
	if resp.Error != nil {
		t.Fatal(resp.Error)
	}
}

func CheckForbiddenStatus(t *testing.T, resp *model.ResponseMetadata) {
	if resp.Error == nil {
...
func CheckUnauthorizedStatus(t *testing.T, resp *model.ResponseMetadata) {
	if resp.Error == nil {
...
func CheckNotFoundStatus(t *testing.T, resp *model.ResponseMetadata) {
	if resp.Error == nil {
...
func CheckBadRequestStatus(t *testing.T, resp *model.ResponseMetadata) {
	if resp.Error == nil {
...
func CheckErrorMessage(t *testing.T, resp *model.ResponseMetadata, message string) {
	if resp.Error == nil {
